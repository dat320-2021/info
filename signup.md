# Signing up to DAT320 Operating Systems and Systems Programming
...
4. You will then be invited to the course organization on GitHub and two separate repositories.
   ...
   - Navigate to the course organization [dat320-2021](https://github.com/dat320-2021) accept the invitation.
   - Navigate to the [assignments](https://github.com/dat320-2021/assignments) repository and accept the invitation.
   - Navigate to your private <https://github.com/dat320-2021/username-labs> repository and accept the invitation. Remember to replace `username` in this link with your own GitHub `username`.
...
5. Once you have accepted the invitations, you will get your own repository under `dat320-2021`, which is the course's organization on GitHub.
...
2. To join our dat320-2021 Discord server, navigate [here](https://discord.gg/fYZwZHArud).
...
3. Once connected to the server, please register with our bot, `@dat320-helpbot`, by sending it a direct message:
   ...
   Hence, please make sure that you have joined the [`dat320-2021`](https://github.com/dat320-2021) GitHub organization and registered with QuickFeed first.
